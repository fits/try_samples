...
export const bindGql = (schemaSrc: string, rootValue: unknown, typeResolvs: ObjMap = {}, contextValue?: unknown) => {
...
export const gqlServe = async (input: GqlServeInput) => {
    ...
    const gqlFunc = bindGql(input.schema, input.rootValue, typeResolvs, input.contextValue)
