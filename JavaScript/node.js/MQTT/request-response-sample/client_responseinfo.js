...
client.on('connect', connack => {
    ...
    const responseInfo = connack.properties.responseInformation

    const responseTopic = responseInfo ?
        `${publishTopic}/${responseInfo}` : 
        `${publishTopic}/response/${client.options.clientId}`
