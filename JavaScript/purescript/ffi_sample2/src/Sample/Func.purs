...
foreign import procData5 :: forall e a. a -> Eff (console :: CONSOLE | e) Unit

foreign import procData6 :: forall e a. Object a -> Eff (console :: CONSOLE | e) Unit
foreign import procData7 :: forall e a. { | a} -> Eff (console :: CONSOLE | e) Unit


foreign import runFunc :: forall e a b. Function a b -> a -> Eff (console :: CONSOLE | e) Unit

foreign import runFunc2 :: forall e a b. Function { | a} b -> { | a} -> Eff (console :: CONSOLE | e) Unit
