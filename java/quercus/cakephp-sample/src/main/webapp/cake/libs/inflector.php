 ...
 */
	var $_transliteration = array(
		...
		'/ﾃ�' => 'Ue',
		'/ﾃ�' => 'Oe',
		'/ﾃ�ﾃ－ﾃ�ﾃポﾃлﾃ�ﾇｺ|ﾄ�ﾄ�ﾄлﾇ�' => 'A',
		'/ﾃ�ﾃ｡|ﾃ｢|ﾃ｣|ﾃ･|ﾇｻ|ﾄ－ﾄポﾄ�ﾇ旨ﾂｪ/' => 'a',
		'/ﾃ�ﾄ�ﾄ�ﾄ掛ﾄ�' => 'C',
		'/ﾃｧ|ﾄ�ﾄ榎ﾄ弓ﾄ�' => 'c',
		'/ﾃ酢ﾄ旨ﾄ�' => 'D',
		'/ﾃｰ|ﾄ楯ﾄ�' => 'd',
		'/ﾃ�ﾃ榎ﾃ掛ﾃ弓ﾄ竹ﾄ培ﾄ翻ﾄ�ﾄ�' => 'E',
		'/ﾃｨ|ﾃｩ|ﾃｪ|ﾃｫ|ﾄ倒ﾄ怖ﾄ慾ﾄ處ﾄ�' => 'e',
		'/ﾄ忿ﾄ桍ﾄ�ﾄ｢/' => 'G',
		'/ﾄ掟ﾄ毫ﾄ｡|ﾄ｣/' => 'g',
		'/ﾄ､|ﾄｦ/' => 'H',
		'/ﾄ･|ﾄｧ/' => 'h',
		'/ﾃ芸ﾃ鋼ﾃ旨ﾃ楯ﾄｨ|ﾄｪ|ﾄｬ|ﾇ楯ﾄｮ|ﾄｰ/' => 'I',
		'/ﾃｬ|ﾃｭ|ﾃｮ|ﾃｯ|ﾄｩ|ﾄｫ|ﾄｭ|ﾇ酢ﾄｯ|ﾄｱ/' => 'i',
		'/ﾄｴ/' => 'J',
		'/ﾄｵ/' => 'j',
		'/ﾄｶ/' => 'K',
		'/ﾄｷ/' => 'k',
		...
		'/ﾃ掃ﾅポﾅ�ﾅ�' => 'N',
		'/ﾃｱ|ﾅлﾅ�ﾅ�ﾅ�' => 'n',
		'/ﾃ竹ﾃ倒ﾃ培ﾃ怖ﾅ芸ﾅ旨ﾇ掃ﾅ酢ﾆ�ﾃ�ﾇｾ/' => 'O',
		'/ﾃｲ|ﾃｳ|ﾃｴ|ﾃｵ|ﾅ鋼ﾅ楯ﾇ竹ﾅ掃ﾆ｡|ﾃｸ|ﾇｿ|ﾂｺ/' => 'o',
		'/ﾅ培ﾅ翻ﾅ�' => 'R',
		'/ﾅ怖ﾅ慾ﾅ�' => 'r',
		'/ﾅ嘶ﾅ忿ﾅ桍ﾅ�' => 'S',
		'/ﾅ斈ﾅ掟ﾅ毫ﾅ｡|ﾅｿ/' => 's',
		'/ﾅ｢|ﾅ､|ﾅｦ/' => 'T',
		'/ﾅ｣|ﾅ･|ﾅｧ/' => 't',
		'/ﾃ處ﾃ嘶ﾃ斈ﾅｨ|ﾅｪ|ﾅｬ|ﾅｮ|ﾅｰ|ﾅｲ|ﾆｯ|ﾇ倒ﾇ怖ﾇ慾ﾇ處ﾇ�' => 'U',
		'/ﾃｹ|ﾃｺ|ﾃｻ|ﾅｩ|ﾅｫ|ﾅｭ|ﾅｯ|ﾅｱ|ﾅｳ|ﾆｰ|ﾇ培ﾇ翻ﾇ�ﾇ嘶ﾇ�' => 'u',
		'/ﾃ掟ﾅｸ|ﾅｶ/' => 'Y',
		'/ﾃｽ|ﾃｿ|ﾅｷ/' => 'y',
		'/ﾅｴ/' => 'W',
		'/ﾅｵ/' => 'w',
 ...
 * ));
 * Inflector::rules('transliteration', array('/ﾃ･/' => 'aa'));
 * }}}
 *
