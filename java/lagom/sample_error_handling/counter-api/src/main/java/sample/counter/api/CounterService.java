...
public interface CounterService extends Service {
	ServiceCall<CreateParameter, CounterState> createCounter();
	ServiceCall<CounterParameter, CounterState> countUp(String id);
	ServiceCall<NotUsed, CounterState> findCounter(String id);
