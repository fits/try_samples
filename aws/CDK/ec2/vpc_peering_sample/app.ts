...
const peerSecurityGroupId = process.env.PEER_SECURITY_GROUP_ID ?? ''
...
const rdsGroup = ec2.SecurityGroup.fromSecurityGroupId(stack, 
    'RDSSecurityGroup', peerSecurityGroupId)

rdsGroup.addIngressRule(ec2Group, ec2.Port.tcp(3306), 'aloow ec2')
