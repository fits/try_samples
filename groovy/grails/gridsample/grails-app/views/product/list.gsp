                ...
                <table>
                    ...
                    <g:each in="${productList}" status="i" var="product">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${product.id}">${product.id?.encodeAsHTML()}</g:link></td>
                        
                            <td>${product.fileName?.encodeAsHTML()}</td>
                        
                            <td>${product.name?.encodeAsHTML()}</td>
                        
                            <td>${product.type?.encodeAsHTML()}</td>
